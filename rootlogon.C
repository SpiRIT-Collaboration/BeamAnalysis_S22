...
void rootlogon()
{
  ...
  TString crtdir = "/home/s015/exp/exp1605_s015/anaroot/users/S22_analysis/";
  gROOT->ProcessLine(".L "+crtdir+"class/BeamRaw_C.so");
  gROOT->ProcessLine(".L "+crtdir+"class/BeamReco_C.so");
  //gROOT->ProcessLine(".L "+mkdir+"class/TBeamEnergy_cc.so");
  //gROOT->ProcessLine(".L "+mkdir+"class/TBDCProjection_cc.so");
 ...
 // gStyle->SetOptDate(1);
  ...
  gROOT->GetColor(7)->SetRGB(0., 0.8, 0.8);// Cyan (0, 1, 1)->(0,0.8,0.8)
